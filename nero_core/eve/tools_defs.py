...
PROPOSE_HYPOTHESIS_TOOL: dict = {
    ...
    "description": (
        ...
        "zscore20, atr14, rsi14, adx14, bb_lower, bb_upper, ret_1, volume, hour_of_day, high20, "
        "low20, vol_ma20, real_yield_10y_chg20, dxy_chg20, vix_chg20, funding_rate_bps; "
        "ops: gt, gte, lt, lte, eq, cross_above, cross_below; conditions are ANDed "
        "together), it will be backtested "
